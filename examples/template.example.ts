import { IExampleTemplate } from "../src/interfaces/IExampleTemplate";
import { ExampleTemplate } from "../src/models/exampleTemplate";

const baseDir = ".";

const exampleSchema: IExampleTemplate = {
  name: "MyApplication",
  type: "folder",
  children: [
    {
...
export const exampleTemplate = new ExampleTemplate(exampleSchema, baseDir);
